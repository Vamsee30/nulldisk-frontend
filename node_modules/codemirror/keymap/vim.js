...
(function(mod) {
  ...
  var defaultExCommandMap = [
    ...
    { name: 'ireload', shortName: 'ir' },
    { name: 'idisable', shortName: 'id' },
    { name: 'ienable', shortName: 'ie' },
    { name: 'wquit', shortName: 'wq' },
...
//      save: function(cm, actionArgs) {
//       console.log('write'+actionArgs)
//      },
    ...
    * in the right place.
    ...
    var exCommands = {
      ...
      ireload: function(cm){
        if(CodeMirror.Vim.image_reload){
          CodeMirror.Vim.image_reload()
        }
      },
      ienable: function(cm){
        if(CodeMirror.Vim.image_enable){
          CodeMirror.Vim.image_enable()
        }
      },
      idisable: function(cm){
        if(CodeMirror.Vim.image_disable){
          CodeMirror.Vim.image_disable()
        }
      },
      wquit: function(cm){
        if(CodeMirror.Vim.wquit){
          CodeMirror.Vim.wquit()
        }
      },
      quit: function(cm){
        if(CodeMirror.Vim.quit){
          CodeMirror.Vim.quit()
        }
      },
