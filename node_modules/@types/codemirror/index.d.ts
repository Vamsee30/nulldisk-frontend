...
declare namespace CodeMirror {
    ...
    var Vim: vimActions;
    type modeOptions = 'normal' | 'visual' | 'insert';

    interface vimActions{
        mapCommand(keys:string, type:string, name:string, args:{}, extra:{}):void,
        map(lhs:string,rhs:string,ctx:modeOptions):void,
    ...
    interface Doc {
        ...
        getSearchCursor(query: string | RegExp, start?: Position, caseFold?: boolean): any;
    ...
    interface CommandActions {
        ...
        save(cm: CodeMirror.Editor): void;
